...
uploader.bind('Init', function(up, params) {
    //显示当前上传方式，调试用
    $('#filelist').html("<div class='hidden'>Current runtime: " + params.runtime + "</div>");
});
uploader.init();
...
uploader.bind('BeforeUpload', function(up, file) {
    var progress = new FileProgress(file, 'fsUploadProgress');
    //up.settings.multipart_params.action = "/rs-put/" + Q.URLSafeBase64Encode(_bucketName + ":" + key);
